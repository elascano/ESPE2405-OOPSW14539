...
import ec.edu.espe.academygradesystemfrm.utils.MongoDBConnectionManager;
...
public class FrmCreateStudent extends javax.swing.JFrame {
    ...
    try {
        ...
        // Crear instancia de StudentToMongo
        MongoDBConnectionManager connectionManager = new MongoDBConnectionManager("yourConnectionString", "AcademyGradeRegister");
        MongoDatabase database = connectionManager.getDatabase();
        StudentToMongo studentService = new StudentToMongo(database);
        
        studentService.uploadStudentData(student);
