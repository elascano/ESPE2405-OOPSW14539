 ...
 * @author WINDOWS
 */
public class FrmSystemForBakery extends javax.swing.JFrame {

    /**
     * Creates new form FrmAcademyGradeRegister
     */
    public FrmSystemForBakery() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        mnuAcademyGradeRegister.setText("SistemForBakery");
        ...
        mnuStudent.setText("Product");

        itmCreateStudent.setText("CreateProduct");
        ...
        itmReadStudent.setText("ReadProduct");
        mnuStudent.add(itmReadStudent);

        itmUpdateStudent.setText("UpdateProduct");
        mnuStudent.add(itmUpdateStudent);

        itmDeleteStudent.setText("DeleteProduct");
        mnuStudent.add(itmDeleteStudent);

        jMenuBar1.add(mnuStudent);

        mnuProfessor.setText("Suppliers");
        jMenuBar1.add(mnuProfessor);

        mnuGrade.setText("Stock");
        jMenuBar1.add(mnuGrade);

        mnuReport.setText("Bill");
    ...
    private void itmCreateStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itmCreateStudentActionPerformed
        FrmAddProduct frmCreateStudent = new FrmAddProduct();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSystemForBakery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSystemForBakery().setVisible(true);
            }
        });
    }
