...
class SchoolApp:
    ...
    def register_school(self):
        ...
        if school_id and name and address and city and phone:
            new_school = School(school_id, name, address, city, phone)
            self.db.insert_school(new_school)
            messagebox.showinfo("Registro Exitoso", "Escuela registrada con éxito.")
        else:
