 ...
 */
public class FrmManagementInventory extends javax.swing.JFrame {

    /**
     * Creates new form FrmInventory
     */
    public FrmManagementInventory() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Administración de Inventario");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmManagementInventory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmManagementInventory().setVisible(true);
            }
        });
    }
