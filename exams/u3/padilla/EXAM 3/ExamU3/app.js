...
mongoose.connect('mongodb+srv://mapadilla12:82410Loveadrian.@adrianpadilla.b8xh14p.mongodb.net/strategyPadilla?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true });
...
const ArrayModel = mongoose.model('arrayAdrian', arraySchema);
